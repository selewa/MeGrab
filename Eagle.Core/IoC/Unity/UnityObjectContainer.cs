...
namespace Eagle.Core.IoC
{
    public class UnityObjectContainer : IObjectContainer
    {
        ...
        {
            this.unityContainer.RegisterType(t, this.GetLifetimeManager(lifetime));
        }
        ...
        public void RegisterType(Type t, string name, ObjectLifetimeMode lifetime)
        {
            this.unityContainer.RegisterType(t, name, this.GetLifetimeManager(lifetime));
        }
        ...
        public void RegisterType(Type from, Type to, string name, ObjectLifetimeMode lifetime)
        {
            this.unityContainer.RegisterType(from, to, name, this.GetLifetimeManager(lifetime));
        }
        ...
        {
            this.unityContainer.RegisterType(typeof(TFrom), to, name, this.GetLifetimeManager(lifetime));
        }
        ...
        {
            this.unityContainer.RegisterType<TFrom, TTo>(name, this.GetLifetimeManager(lifetime));
        }
